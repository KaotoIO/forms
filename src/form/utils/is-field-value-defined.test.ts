...
describe('isFieldValueDefined', () => {
  ...
  describe('when schema type is boolean', () => {
    ...
    it('should return false for non-boolean values', () => {
      expect(isFieldValueDefined('boolean', 'true')).toBe(false);
      expect(isFieldValueDefined('boolean', 1)).toBe(false);
      expect(isFieldValueDefined('boolean', 0)).toBe(false);
      expect(isFieldValueDefined('boolean', 'false')).toBe(false);
      expect(isFieldValueDefined('boolean', {})).toBe(false);
      expect(isFieldValueDefined('boolean', [])).toBe(false);
    });
  });
  ...
  describe('when schema type is string', () => {
    ...
    it('should return false for empty string', () => {
      expect(isFieldValueDefined('string', '')).toBe(false);
    });
  ...
  describe('when schema type is number', () => {
    ...
    it('should return false for empty string', () => {
      expect(isFieldValueDefined('number', '')).toBe(false);
    });
